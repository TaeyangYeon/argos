...
## 전체 진행률
- 완료: 2 / 50 Steps
- 현재 Phase: Phase 1 — 프로젝트 기반 구축 (진행 중)
...
| Phase | 범위 | 상태 |
|-------|------|------|
| Phase 1 | Step 1~8 — 프로젝트 기반 구축 | 🔄 진행 중 |
| Phase 2 | Step 9~16 — UI 기본 골격 | 🔲 대기 |
...
| 3 | 설정 및 상수 관리 모듈 | 🔲 대기 | - | |
| 4 | 로깅 및 에러 핸들링 기반 | 🔲 대기 | - | |
| 5 | AI Provider Layer 기반 | 🔲 대기 | - | |
| 6 | API Key 암호화 저장 모듈 | 🔲 대기 | - | |
| 7 | 입력 검증 레이어 구현 | 🔲 대기 | - | |
| 8 | 이미지 데이터 모델 및 저장소 | 🔲 대기 | - | |
| 9 | PyQt6 메인 윈도우 및 레이아웃 | 🔲 대기 | - | |
| 10 | 상단 툴바 및 API 입력 버튼 | 🔲 대기 | - | |
| 11 | 좌측 사이드바 네비게이션 | 🔲 대기 | - | |
| 12 | 대시보드 화면 | 🔲 대기 | - | |
| 13 | 이미지 업로드 화면 (기본) | 🔲 대기 | - | |
| 14 | 이미지 썸네일 그리드 및 관리 | 🔲 대기 | - | |
| 15 | ROI 설정 화면 | 🔲 대기 | - | |
| 16 | 설정 화면 | 🔲 대기 | - | |
