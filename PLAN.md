...
- ui/pages/purpose_page.py: PurposePage 구현
  (검사 유형 exclusive 토글, 예시 텍스트 자동 변경,
   PurposeValidator 연동, purpose_confirmed 시그널)
- ui/components/sidebar.py: PageID.PURPOSE 추가, 🎯 검사 목적 메뉴 추가
- ui/main_window.py: PurposePage 등록 및 시그널 연결
- tests/unit/test_purpose_page.py: 7개 테스트 추가
